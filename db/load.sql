...
\COPY Users FROM '/home/vcm/mini-amazon/db/data/complete/users.csv' WITH DELIMITER '^' NULL '' CSV
...
\COPY Categories FROM '/home/vcm/mini-amazon/db/data/complete/categories.csv' WITH DELIMITER '^' NULL '' CSV
...
\COPY Products (id, name, description, img_url, category) FROM '/home/vcm/mini-amazon/db/data/complete/products.csv' WITH DELIMITER '^' NULL '' CSV
-- \COPY Products (id, name, description, img_url, category) FROM 'Products.csv' WITH DELIMITER ',' NULL '' CSV
SELECT pg_catalog.setval('public.products_id_seq',
                         (SELECT MAX(id)+1 FROM Products),
                         false);  
                         
\COPY Purchases FROM '/home/vcm/mini-amazon/db/data/complete/purchases.csv' WITH DELIMITER '^' NULL '' CSV
SELECT pg_catalog.setval('public.purchases_id_seq',
                         (SELECT MAX(id)+1 FROM Purchases),
                         false);

\COPY Inventory FROM '/home/vcm/mini-amazon/db/data/complete/inventory.csv' WITH DELIMITER '^' NULL ''  CSV;
...
\COPY OrderHistory FROM '/home/vcm/mini-amazon/db/data/complete/orderhistory.csv' WITH DELIMITER '^' NULL '' CSV;
